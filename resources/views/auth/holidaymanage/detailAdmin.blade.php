    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            @endif
                ...
                <form action="{{url('/viewholidayadmin/detail/'.$user->holiday_id)}}" method="POST">
                    @csrf
                    @method("PUT")
                    <div class="col-md-6">
                        <button type="submit" value="1" name="checked"class="btn btn-primary">Accept</button>
                        <button type="submit" value="2" name="checked" class="btn btn-danger">Deny</button>
                    </div>
                </form>
                {{-- <div class="mb-3">
                    <label >Email</label>
